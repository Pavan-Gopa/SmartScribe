# Commercial use of SmartScribe

SmartScribe is free for **personal / noncommercial** use under the
[PolyForm Noncommercial License 1.0.0](LICENSE).

## When you need a commercial license

You need a **paid commercial license** if SmartScribe is used for a
**business or company purpose**, including for example:

- Installing or running SmartScribe on company-owned devices
- Using SmartScribe as part of paid work, client delivery, or internal business operations
- Deploying SmartScribe for employees, contractors, or teams in an organization
- Bundling, reselling, or offering SmartScribe (or a modified version) as a product or service
